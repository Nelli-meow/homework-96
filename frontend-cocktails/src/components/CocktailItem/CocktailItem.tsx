...
const CocktailItem: React.FC<CocktailProps> = ({name, image, recipe}) => {
  const imageSrc = image ? `${apiURL}/${image}` : NoPic;

  return (
    <>
      <div
        className="max-w-sm bg-gradient-to-b from-blue-100 via-indigo-100 to-purple-200 border border-indigo-300 rounded-lg shadow-md mb-5">
        <a href="#">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-blue-600 overflow-hidden text-ellipsis whitespace-nowrap">
            {recipe}
          </p>
          <a
            href="#"
